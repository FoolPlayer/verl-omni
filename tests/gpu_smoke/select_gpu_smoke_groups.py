...
GROUP_PATTERNS = {
    ...
    "ci-e2e-omni": (
        ...
        "verl_omni/workers/engine/veomni/qwen3_omni_thinker_impl.py",
        "verl_omni/workers/engine/packed_prompt_region.py",
        "examples/gspo_trainer/qwen3_omni/run_qwen3_omni_thinker_gspo_veomni.sh",
