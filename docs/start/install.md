...
torch/vLLM stack is preserved, then add its media runtime dependencies. This is
the shared CI install; Qwen3-Omni Thinker also needs the kernels listed below.
